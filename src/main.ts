...
initValues.initialData.basic.valueWood = 11;
initValues.initialData.dev.valueWood = 12;
initValues.initialData.basic.coastCar = 1270000;
initValues.initialData.dev.coastCar = 1300000;
...
initValues.operatorSalary.basic.basic = consumerCosts1.setMainSalaryMainEmploy(initValues.operatorSalary.basic.salaryHour, 1.9).mSalaryMain;
initValues.operatorSalary.basic.socialInsurance = consumerCosts1.setMainSalaryMainEmploy(initValues.operatorSalary.basic.salaryHour,1.9).ozpMain;
initValues.auxiliaryWorkersSalary.basic.basic = consumerCosts1.setMainSalaryMainEmploy(
  initValues.operatorSalary.basic.salaryHour,
  1.35,
  0.76
).mSalaryMain;
initValues.auxiliaryWorkersSalary.basic.socialInsurance = consumerCosts1.setMainSalaryMainEmploy(
  initValues.operatorSalary.basic.salaryHour,
  1.35,
  0.76
).ozpMain;

initValues.expenses.basic.PerShift = consumerCosts1.setFuelCoast(initValues.initialData.basic.coefEng).fuelSm;
initValues.expenses.basic.fuelPerShift = consumerCosts1.setFuelCoast(initValues.initialData.basic.coefEng).fuelCoast;
initValues.expenses.basic.motor = consumerCosts1.setLubricantCoast(0.039, 18, 'engine');
initValues.expenses.basic.hydraulic = consumerCosts1.setLubricantCoast(0.019, 18.5, 'hidro');
initValues.expenses.basic.transmission = consumerCosts1.setLubricantCoast(0.01, 6.75, 'trans');
initValues.expenses.basic.plastic = consumerCosts1.setLubricantCoast(0.008, 13.5, 'plastic');
initValues.expenses.basic.totalFuelAndLubric = consumerCosts1.countCoastFuelLubricant();
initValues.expenses.basic.maintenance = consumerCosts1.setCoastRepair(initValues.initialData.basic.Repair);
...
initValues.expenses.basic.numFlights = consumerCosts1.setTireCoast(
  performanceCar1.pSmen , initValues.initialData.basic.valueWood
).numFlights;
...
initValues.expenses.dev.PerShift = consumerCosts2.setFuelCoast(initValues.initialData.dev.coefEng).fuelSm;
initValues.expenses.dev.fuelPerShift = consumerCosts2.setFuelCoast(initValues.initialData.dev.coefEng).fuelCoast;
initValues.expenses.dev.motor = consumerCosts2.setLubricantCoast(0.039, 18, 'engine');
initValues.expenses.dev.hydraulic = consumerCosts2.setLubricantCoast(0.019, 18.5, 'hidro');
initValues.expenses.dev.transmission = consumerCosts2.setLubricantCoast(0.01, 6.75, 'trans');
initValues.expenses.dev.plastic = consumerCosts2.setLubricantCoast(0.008, 13.5, 'plastic');
initValues.expenses.dev.totalFuelAndLubric = consumerCosts2.countCoastFuelLubricant();
initValues.expenses.dev.maintenance = consumerCosts2.setCoastRepair(initValues.initialData.dev.Repair);
...
initValues.expenses.basic.capexPerOutput = propertyEfficient1.setSpecialInvest();
...
initValues.annualProductivityGrowth = generalEfficient.setSpecialInvest().increaseYearProj;
initValues.annualEconomicEffect = generalEfficient.setSpecialInvest().efficientYear;
...
saveObjectToFile('test-1.json', initValues);